<div class="footer-callto-action-area bg-light-1" style="padding-top:100px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="call-to-sction bg_image shape-move">
                        <h2 class="title">Skills Certificate From <br> the Groviio</h2>
                        {{-- <a href="course-one.html" class="rts-btn btn-primary-white with-arrow">View All Course <i class="fa-regular fa-arrow-right"></i></a> --}}
                        <a href="{{ url('enquire-us') }}" class="rts-btn btn-primary-white with-arrow">Enquiry Now<i class="fa-regular fa-arrow-right"></i></a>
                        <div class="cta-image">
                        ...
                        <div class="footer-singl-wized left-logo">
                            ...
                            <div class="body">
                                ...
                                <ul class="wrapper-list">
                                    <li><i class="fa-regular fa-location-dot"></i>Yarra Park, Hyderabad, India </li>
                                    <li><i class="fa-regular fa-phone"></i><a href="tel:+91 96524 47037">+91 96524 47037</a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-area-one">
                            <p>Copyright © 2025 All Rights Reserved by Groviio</p>
