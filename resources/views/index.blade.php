...
<head>
    ...
    <title>Business Development Representative (BDR) Training | Groviio</title>
    ...
    <!-- jquery ui css -->
    <link rel="stylesheet" href="{{ asset('web-assets/css/vendor/jquery-ui.css') }}">
    <!-- metismenu scss -->
                    ...
                    <div class="banner-content-one">
                        <div class="inner">
                            <div class="pre-title-banner">
                                <img src="{{ asset('web-assets/images/banner/bulb.png') }}" width="22" alt="icon">
                                <span>Master the Art of Business Development with Groviio!</span>
                            </div>
                            <h1 class="title-banner">
                                Business Development <br>
                                <span>Representative Training</span>
                                <img src="{{ asset('web-assets/images/banner/02.png') }}" alt="banner">
                            </h1>
                            <p class="disc">Course Duration: 3 Months (12 Weeks)
- Schedule: Weekly live sessions (2-3 hours each) + Assignments and practical exercises
</p>
                            <div class="banner-btn-author-wrapper">
                                <a href="course-five.html" class="rts-btn btn-primary with-arrow">Course Overview <i class="fa-regular fa-arrow-right"></i></a>
                                <div class="sm-image-wrapper">
                                    <div class="images-wrap">
                                        <img src="{{ asset('web-assets/images/banner/shape/06.png') }}" alt="banner">
                                        <img class="two" src="{{ asset('web-assets/images/banner/shape/07.png') }}" alt="banner">
                                        <img class="three" src="{{ asset('web-assets/images/banner/shape/08.png') }}" alt="banner">
                                    </div>
                                    <div class="info">
                ...
                <div class="col-lg-6 order--xl-2 order-lg-2 order-sm-1 order-1">
                    <div class="banner-right-img">
                        <img src="{{ asset('web-assets/images/banner/01.png') }}" alt="banner">
                    </div>
                </div>
            </div>
        </div>
        <div class="review-thumb">
            ...
            <div class="review-single two">
                <img src="{{ asset('web-assets/images/banner/04.png') }}" alt="banner">
                <div class="info-right">
                    <h6 class="title">100+
                    </h6>
        ...
        <div class="shape-image">
            <div class="shape one" data-speed="0.04" data-revert="true"><img src="{{ asset('web-assets/images/banner/shape/banner-shape01.svg') }}" alt="shape_image"></div>
            <div class="shape two" data-speed="0.04"><img src="{{ asset('web-assets/images/banner/shape/banner-shape02.svg') }}" alt="shape_image"></div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="{{ asset('web-assets/images/brand/08.svg') }}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="{{ asset('web-assets/images/brand/09.svg') }}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="{{ asset('web-assets/images/brand/10.svg') }}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="{{ asset('web-assets/images/brand/11.svg') }}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                                <!-- single swiper style -->
                                ...
                                <div class="swiper-slide">
                                    <div class="brand-area">
                                        <img src="{{ asset('web-assets/images/brand/13.svg') }}" alt="brand">
                                    </div>
                                </div>
                                <!-- single swiper style -->
                            </div>
                ...
                <div class="col-lg-6 pl--90 pl_sm--15 pt_sm--50">
                    <div class="title-area-left-style">
                        <div class="pre-title">
                            ...
                            <span> Empowering BDRs, Driving Sales Success!</span>
                        </div>
                        <h2 class="title">About Groviio</h2>
                        <p class="post-title">At Groviio, we are pioneers in Business Development Representative (BDR) Training, dedicated to empowering sales teams with the skills, strategies, and confidence they need to excel. With 15 years of experience, we have transformed organizations by refining their outreach, prospecting, and lead conversion techniques.</p>
                    </div>
                    ...
                    <a href="single-course.html" class="rts-btn btn-primary-white with-arrow">Read more.. <i class="fa-regular fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        <div class="shape-image">
                ...
                <div class="col-lg-12">
                    <div class="title-area-center-style">
                        <div class="pre-title">
                            ...
                            <span>Join Groviio’s training programs today!</span>
                        </div>
                        <h2 class="title">Our Courses</h2>
                        <p class="post-title">Learn without limits. Start, switch, or advance your career </p>
                    </div>
                </div>
            </div>
            <div class="row mt--50">
                            ...
                            <div class="img-information">
                                ...
                                <div class="information">
                                    ...
                                    <a href="event-details.html">
                                        <h5 class="title">Business Development Representative (BDR) Training </h5>
                                    </a>
                                </div>
                            </div>
                            <a href="event-details.html" class="rts-btn btn-primary with-arrow">Enroll <i class="fa-light fa-arrow-right"></i></a>
                        </div>
                        <!-- single -->
                        <!-- single -->
                    ...
                    <div class="about-inner-right-one">
                        <div class="what-you-get">
                            ...
                            <div class="single-facilityes">
                                ...
                                <div class="information">
                                    <h5 class="title">15+ Years of Expertise </h5>
                                    <p>With over a decade and a half of experience, we have honed our BDR training programs to perfection, ensuring they align with industry standards and evolving market trends.</p>
                                </div>
                            ...
                            <div class="single-facilityes">
                                ...
                                <div class="information">
                                    <h5 class="title">Proven Sales Development Strategies </h5>
                                    <p>Our training isn't just theoretical—it’s built on real-world success stories and best practices that have helped countless businesses boost their sales pipelines and conversion rates.</p>
                                </div>
						...
						<div class="what-you-get">
                            ...
                            <div class="single-facilityes">
                                ...
                                <div class="information">
                                    <h5 class="title">Customized Training Solutions </h5>
                                    <p>Every business is unique, and so are its challenges. We tailor our training programs to meet the specific needs of your team, ensuring maximum impact and measurable growth.</p>
                                </div>
						...
						<div class="what-you-get">
                            ...
                            <div class="single-facilityes">
                                ...
                                <div class="information">
                                    <h5 class="title">Practical, Hands-on Learning </h5>
                                    <p>We believe in learning by doing. Our training includes live role-plays, scenario-based exercises, and actionable frameworks to help BDRs implement strategies effectively</p>
                                </div>
