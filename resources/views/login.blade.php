  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
      <div class="flex-row text-center mx-auto">
        <img src="{{ asset('assets/images/banner/login-bg.png') }}" alt="Auth Cover Bg color" width="520" class="img-fluid authentication-cover-img" data-app-light-img="banner/login-bg.png" data-app-dark-img="banner/login-bg.png">
        <div class="mx-auto">
      ...
      <div class="w-px-400 mx-auto">
        ...
        <div class="app-brand mb-4">
          <a href="{{url('/')}}" class="app-brand-link gap-2 mb-2">
            <span class="demo align-items-center">
